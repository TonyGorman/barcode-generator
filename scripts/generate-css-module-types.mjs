...
const formatDeclarationContent = async (content, filePath) => {
...
const main = async () => {
  for (const cssModuleFile of cssModuleFiles) {
    ...
    const declarationRawContent = buildDeclarationContent(classNames)
    const declarationContent = await formatDeclarationContent(declarationRawContent, declarationPath)
