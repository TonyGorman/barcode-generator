...
export const useAisleLabelForm = ({
  ...
  const {
    state: { errorMessage, warningMessage, generatedLabels },
  ...
  const onInputChange = React.useCallback(
    (e: React.ChangeEvent<HTMLInputElement>, type: NumericAisleInputKey): void => {
  ...
  const formatTwoDigits = React.useCallback(
